...
module.exports = {
    name: 'play',
    aliases: ['skip', 'stop', 'shuffle', 'loop'], //We are using aliases to run the skip and stop command follow this tutorial if lost: https://www.youtube.com/watch?v=QBUJ3cdofqc
    cooldown: 0,
